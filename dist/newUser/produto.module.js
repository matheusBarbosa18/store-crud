...
const new_user_controller_1 = require("./controller/new-user.controller");
...
exports.ProdutoModule = ProdutoModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [new_user_controller_1.NewUserController],
        providers: [new_user_service_1.NewUserService],
        exports: [new_user_service_1.NewUserService],
    })
], ProdutoModule);
